...
public class frmMain extends javax.swing.JFrame {
  ...
  public frmMain() {
		...
		frmPreferences1.ReadPreferenceFile();  //look for and read preferences.txt to set paths
		jcDBNames = frmPreferences1.getDBNames();
		if (jcDBNames.isEmpty()) { strDBtoConnect = "NONE"; }
		else { strDBtoConnect = (String)jcDBNames.get(0); }
		...
		//loads the class frmLoadData and shows it in frmMain's jDesktopPane1 strDBtoConnect
  ...
  private void initComponents() {//GEN-BEGIN:initComponents
	...
	private void mnuPreferencesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuPreferencesActionPerformed
		//loads the class frmPreferences and shows it in frmMain's jDesktopPane1
    frmPreferences frmPreferences1 = new frmPreferences();
	...
	public static Connection getDatabaseConnection() {
	  ...
	  try {
			...
			Connection conData = DriverManager.getConnection("jdbc:mysql://localhost/" + strDBtoConnect, strDBUserID, strDBPassword);
			return conData;
	  }
	...
	public static void setDBName(String strDBName) { strDBtoConnect = strDBName; }
	public static String getDBName() { return strDBtoConnect; }

  public static void setDBUserID(String strDBUserID1) { strDBUserID = strDBUserID1; }

  public static void setDBPassword(String strDBPassword1) { strDBPassword = strDBPassword1; }
